...
This directory contains scripts for maintaining code quality, architectural integrity, and generating project
documentation.
...
The `pre_commit_checks.sh` script performs fast checks (linting, formatting, type-checking, and unit tests) that should
...
The `pre_push_checks.sh` script runs the full test suite, including integration and acceptance tests. It is recommended
to run this before pushing to a remote or merging a PR.
